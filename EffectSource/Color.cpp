...
Color::color_t const * const noColor = nullptr;
Color::color_t const * const oldColor = nullptr; 

const Color::color_t color_Black = {0x00, 0x00, 0x00, 0x00};
const Color::color_t color_Red = {0xFF, 0x00, 0x00, 0x00};
const Color::color_t color_Green = {0x00, 0xFF, 0x00, 0x00};
const Color::color_t color_Blue = {0x00, 0x00, 0xFF, 0x00};
const Color::color_t color_Magenta = {0x80, 0x00, 0x80, 0x00};
const Color::color_t color_Cyan = {0x00, 0x80, 0x80, 0x00};
const Color::color_t color_Yellow = {0x80, 0x80, 0x00, 0x00};
const Color::color_t color_White = {0x55, 0x55, 0x55, 0x00};
const Color::color_t color_WarmWhite = {0x7F, 0x4F, 0x4F, 0x00};
const Color::color_t color_ColdWhite = {0x4F, 0x4F, 0x7F, 0x00};
const Color::color_t color_SpookyWhite = {0x4F, 0x7F, 0x4F, 0x00};
