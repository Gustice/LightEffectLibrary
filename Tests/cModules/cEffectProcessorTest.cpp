...
// TEST_CASE("Constructing cEffectProcessor", "[cEffectProcessor, Constructor]") {
//     cEffectProcessor dut(12, 3);
//     REQUIRE(true);
// }
...
//         {Light_Idle, noWave, 0xFF, 4, oldColor, 0, 0},
//     };
//     Macro_t effDemo2[] = {
//         // State      WV            FS    N  Start         R  Next
//         {Light_Idle, noWave, 0xFF, 4, &color_Green, 0, 1},
//         {Light_Idle, noWave, 0xFF, 4, oldColor, 0, 0},
//     };
//     uint8_t fullIntens = 0xFFu;
//     uint8_t halfIntens = 0x80u;

//     cEffectProcessor dut(u8_testWaveLen, 2);
...
//     Macro_t effDemo1[] = {
//         // State      WV            FS    N  Start         R  Next
//         {Light_Idle, noWave, 0xFF, 8, &color_Blue, 0, 1},
//         {Light_Idle, noWave, 0xFF, 8, oldColor, 0, 0},
//     };
//     Macro_t effDemo2[] = {
//         // State      WV            FS    N  Start         R  Next
//         {Light_Idle, noWave, 0xFF, 8, &color_Green, 0, 1},
//         {Light_Idle, noWave, 0xFF, 8, oldColor, 0, 0},
//     };
//     uint8_t fullIntens = 0xFFu;
//     uint8_t halfIntens = 0x80u;

//     cEffectProcessor dut(u8_testWaveLen, 4);
//     dut.SetEffect(effDemo1, noColor, 0xFF);
...
//     Macro_t effDemo1[] = {
//         // State      WV            FS    N  Start         R  Next
//         {Light_Blank, noWave, 0xFF, 8, &color_Red, 0, 1},
//         {Light_Wave, gau8_initSlope, 0xFF, 32, oldColor, 0, 2},
//         {Light_Wave, gau8_offsetPulse, 0xFF, 64, oldColor, 0, 3},
//         {Light_Idle, noWave, 0xFF, 62, oldColor, 0, 2},
//     };
//     Macro_t effDemo2[] = {
//         // State      WV            FS    N  Start         R  Next
//         {Light_Blank, noWave, 0xFF, 4, &color_Green, 0, 1},
//         {Light_Wave, gau8_fullPulse, 0xFF, 16, oldColor, 3, 2},
//         {Light_Blank, noWave, 0xFF, 64, &color_Green, 0, 1},
//     };

//     cEffectProcessor dut(cu16_TemplateLength, 16);
